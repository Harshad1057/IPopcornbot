...
class Config(object):
    API_ID = int(os.getenv("API_ID", "21709347"))
    API_HASH = os.getenv("API_HASH", "4a164c988Beaaadaabcc222109345596")
    BOT_TOKEN = os.getenv("BOT_TOKEN", "6426682314:AAENHcCTIC3pBizPRDq_3tJH-hMH-rein6o")
    BOT_SESSION_NAME = os.getenv("BOT_SESSION_NAME", "i_Popcorn_movies_bot")
    USER_SESSION_STRING = os.getenv("USER_SESSION_STRING", "BQC6kfsAAjMqmn9qBYjR0HOd09EfP7gYmbzl3w_x00JQVoOV_qssWWsln0QPQDfmTkG-TsudyPY-iIAWw0E7uqcmwMRGoxle_UrqyFymhxWrdkkGaUCN6oQ6NmY9O5Op62G4SQVeITqV2z2rK9pRn6D9PAuH5SiG0hi1mi8wnaI09O5iuZ6AV-X38zq3r2OPpxhuAegSWFudnJMf1P9CTTc1PJtfFWls5kyt7R9DY468tWngtuFaAZYpTHtu-m6rqrV6c7S-dK-PWhyPvoy24AbeGuK7JsEbxNE2vZyCwUuAV_G26ZSIy4_OxGpRYKMVsa6JnPnBvzw7na1NBLAAcg1KHuMftQAAAAFHOcfJAA")
    CHANNEL_ID = int(os.getenv("CHANNEL_ID", "-1002040777205")) 
    BOT_USERNAME = os.getenv("BOT_USERNAME", "i_Popcorn_movies_bot")
    BOT_OWNER = int(os.getenv("BOT_OWNER", "5489936329"))
...
Jᴜsᴛ Tʏᴘᴇ ᴀ Mᴏᴠɪᴇ Nᴀᴍᴇ 🎬**""" ) 
    START_PHOTO = os.getenv("START_PHOTO", "https://graph.org/file/e8a03855d86ebea2df729.jpg")
    HOME_TEXT = os.getenv("HOME_TEXT", """ᴀᴅᴅ ᴍᴇ ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴘ ➕

ɪ ᴄᴀɴ ᴘʀᴏᴠɪᴅᴇ ᴛʜᴇʀᴇ ʏᴏᴜʀ ʟɪɴᴋꜱ.

ꜰᴏʀ ᴍᴏʀᴇ ɪɴꜰᴏ ᴄʟɪᴄᴋ ᴏɴ ʜᴇʟᴘ ✅""" )
    UPDATES_CHANNEL = os.getenv("UPDATES_CHANNEL", "-1002053763865")
    DATABASE_URL = os.getenv("DATABASE_URL", "mongodb+srv://Harshad1057:Harshad1057@cluster0.1a6nnoe.mongodb.net/?retryWrites=true&w=majority")
    LOG_CHANNEL = int(os.getenv("LOG_CHANNEL", "-1002045876538"))
    RESULTS_COUNT = int(os.getenv("RESULTS_COUNT", 20))
    BROADCAST_AS_COPY = os.getenv("BROADCAST_AS_COPY", "True")
    UPDATES_CHANNEL_USERNAME = os.getenv("UPDATES_CHANNEL_USERNAME", "i_Popcorn_movies_bot")
    FORCE_SUB = os.getenv("FORCE_SUB", "False")
    AUTO_DELETE_TIME = int(os.getenv("AUTO_DELETE_TIME", 180))
    MDISK_API = os.getenv("MDISK_API", "Wjwj10EVUMTQ0Eb2AUEoxP4laNc2")
